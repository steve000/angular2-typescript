...
var _1 = require('./');
var SchintacloudAdminModule = (function () {
    function SchintacloudAdminModule() {
    }
    SchintacloudAdminModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return SchintacloudAdminModule;
}());
exports.SchintacloudAdminModule = SchintacloudAdminModule;
