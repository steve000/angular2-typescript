...
var _1 = require('./');
var SchintacloudSharedModule = (function () {
    function SchintacloudSharedModule() {
    }
    SchintacloudSharedModule = __decorate([
        core_1.NgModule({
            imports: [
                _1.SchintacloudSharedLibsModule,
                _1.SchintacloudSharedCommonModule
            ],
            declarations: [
    ...
    return SchintacloudSharedModule;
}());
exports.SchintacloudSharedModule = SchintacloudSharedModule;
