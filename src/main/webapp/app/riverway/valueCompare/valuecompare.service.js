...
var ValueCompareService = (function () {
    // private startTime= "2017-01-01-01";
    // private endTime= "2017-01-06-23";
    function ValueCompareService(http) {
        this.http = http;
    ...
    ValueCompareService.prototype.getData = function () {
    ...
    ;
    ValueCompareService.prototype.outDataY = function () {
    ...
    ValueCompareService.prototype.handleError = function (error) {
        console.error('An error occurred', error);
        return Promise.reject(error.message || error);
    };
    ValueCompareService = __decorate([
        core_1.Injectable()
    ], ValueCompareService);
    return ValueCompareService;
}());
exports.ValueCompareService = ValueCompareService;
//# sourceMappingURL=valuecompare.service.js.map